                ...
                <a href="/agents" class="block">
                    <Card>
                        <div class="p-6 flex items-center gap-4 hover:bg-muted/50 transition-colors rounded-xl">
                            ...
                            <div>
                                <h3 class="font-semibold text-foreground">"Agents"</h3>
                                <p class="text-sm text-muted-foreground">"Use AI agents with tools"</p>
                            </div>
                        </div>
                    </Card>
                </a>
                ...
                <div class="p-6">
                    ...
                    <ul class="space-y-3 text-sm text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            "Use Agents for complex tasks with tool access"
                        </li>
                    </ul>
                </div>
            </Card>
